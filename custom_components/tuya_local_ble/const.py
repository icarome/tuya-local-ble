...
SIGNAL_DYNAMIC_PASSWORD_UPDATE: Final = "tuya_local_ble_dynamic_password_update"
EVENT_DYNAMIC_PASSWORD_GENERATED: Final = "tuya_local_ble_dynamic_password_generated"
SERVICE_GET_DYNAMIC_PASSWORD: Final = "get_dynamic_password"
